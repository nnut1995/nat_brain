...
- Staff confirm bookings; walk-ins depend on availability, class payment is afterward, and admin handles exceptions.
- Stay & Train uses a 50% reservation deposit, balance before check-in, Monday–Saturday training and private AC rooms.

## Key claims
### Classes, packages and booking
- Nat confirms all poster prices and schedules; trial is 400 THB with no discount. Monthly memberships allow one session daily; package validity begins on the first class. ([[wiki/sources/2026-09-26-n-and-p-owner-chatbot-policies]])
...
- Complete beginners may join group classes. Sparring occurs in most classes but is optional; customers can tell the trainer they do not want it. Capacity is six, with larger groups by request. ([[wiki/sources/2026-09-26-n-and-p-owner-chatbot-policies]])
- Gloves and wraps are free to borrow; sportswear is sufficient. Showers and parking are free, drinking water is sold, and lockers are unavailable. ([[wiki/sources/2026-09-26-n-and-p-owner-chatbot-policies]])
- Customers may choose a trainer; trainers speak Thai and a little English, while reception can communicate in English. Injury/health enquiries go to admin. ([[wiki/sources/2026-09-26-n-and-p-owner-chatbot-policies]])
...
## Notable quotes
- "1 session per day"
- "customer can leave message anytime"
- "half deposit to reserve the riim and full before check in"
...
> [!warning] Contradiction — residential schedule and checkout
> The September 8 website said daily training without closures and checkout by noon. Nat now specifies no Sunday training and checkout at 13:00. Use the owner's newer answers for customer replies; retain the older website record as historical evidence. See [[wiki/sources/2026-09-08-nandpmuaythai-com]].
